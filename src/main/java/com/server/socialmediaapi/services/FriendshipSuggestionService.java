...
public class FriendshipSuggestionService {
    ...
    @Transactional
    public void suggestFriendship(FriendshipSuggestionRequestDTO dto){
        subscriptionService.subscribe(dto);

        friendshipSuggestionRepo.save(createFriendshipSuggestion(dto));
    }

    private FriendshipSuggestion createFriendshipSuggestion(FriendshipSuggestionRequestDTO dto) {
